...
class Pacientes extends Model
{
    ...
    public static function recaudoCaja($fecIni)
    {
        ...
        $recaudo = DB::connection('mysql')
            ->table('pagos')
            ->join('servicios', 'servicios.id', 'pagos.id_servicio')
    ...
    /**
     * Obtiene los pacientes que cumplen años hoy
     */
    public static function getPacientesCumpleanosHoy()
    {
        $hoy = date('m-d');
        
        return DB::connection('mysql')->table('pacientes')
            ->where('estado', 'ACTIVO')
            ->whereRaw("DATE_FORMAT(fecha_nacimiento, '%m-%d') = ?", [$hoy])
            ->select('id', 'primer_nombre', 'segundo_nombre', 'primer_apellido', 'segundo_apellido', 'fecha_nacimiento', 'edad', 'foto')
            ->get();
    }
     ...
     */
    public static function getPacientesCumpleanosProximos()
    {
        $hoy = date('Y-m-d');
        ...
        return DB::connection('mysql')->table('pacientes')
            ->where('estado', 'ACTIVO')
            ->whereRaw("DATE_FORMAT(fecha_nacimiento, '%m-%d') >= DATE_FORMAT(?, '%m-%d')", [$hoy])
            ->whereRaw("DATE_FORMAT(fecha_nacimiento, '%m-%d') <= DATE_FORMAT(?, '%m-%d')", [$proximaSemana])
            ->select('id', 'primer_nombre', 'segundo_nombre', 'primer_apellido', 'segundo_apellido', 'fecha_nacimiento', 'edad', 'foto')
    ...
    /**
     * Cuenta los pacientes que cumplen años hoy
     */
    public static function contarPacientesCumpleanosHoy()
    {
        $hoy = date('m-d');
