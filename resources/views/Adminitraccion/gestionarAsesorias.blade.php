...
@section('title', 'Gestionar servicios a entidades')
@section('Contenido')
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h4 class="page-title">Gestionar servicios a entidades</h4>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                            <li class="breadcrumb-item" aria-current="page">Inicio</li>
                            <li class="breadcrumb-item active" aria-current="page">Gestionar servicios a entidades</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div id="listado" class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Listado de servicios a entidades </h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="box-header-actions">
                                <div class="input-group input-group-merge">
                                    ...
                                    <button type="button" onclick="nuevoRegistro(1);"
                                        class="btn btn-xs btn-primary font-bold"><i class="fa fa-plus"></i> Nuevo servicio</button>
                                </div>
    ...
    <!-- MODAL PAUETES -->
    <div class="modal fade" id="modalAsesorias" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 40%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="tituloAccion">Agregar servicio</h4>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let menuA = document.getElementById("principalParametrosAsesorias")
            ...
            $("#formAsesorias").validate({
                ...
                messages: {
                    ...
                    valorVis: {
                        required: "Por favor, el valor del servicio.",
                    }
                },
        ...
        function guardarRegistro() {
            ...
            if ($("#formAsesorias").valid()) {

                const formAsesorias = document.getElementById('formAsesorias');
                const formData = new FormData(formAsesorias);

                const url = "{{ route('form.guardarAsesoria') }}";
        ...
        function editarRegistro(idRegistro) {
            var modal = new bootstrap.Modal(document.getElementById("modalAsesorias"), {
                backdrop: 'static',
                keyboard: false
            });
            ...
            document.getElementById("tituloAccion").innerHTML  = "Editar servicio"

            modal.show();

            let url = "{{ route('asesorias.buscarAsesoria') }}";
        ...
        function nuevoRegistro(opc) {
            ...
            document.getElementById("tituloAccion").innerHTML  = "Agregar servicio"
        }
        ...
        function eliminarRegistro(idReg) {
            swal({
                ...
                if (isConfirm) {
                    let url = "{{ route('asesorias.eliminarAsesoriaLista') }}";
                    fetch(url, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
        ...
        function cargar(page, searchTerm = '') {
            ...
            let url = "{{ route('asesorias.listaAsesorias') }}"; // Definir la URL
            ...
            fetch(url, {
                ...
                .then(responseData => {
                    ...
                    document.getElementById('trRegistros').innerHTML = responseData.asesorias;
                    feather.replace();
