                                    ...
                                    <div class="card-body">
                                        <div class="card-header">
                                            <h5 class="text-uppercase"><i class="fa fa-h-square me-1"></i>
                                                Evaluación clínica neuropsicológica</h5>
                                            <div>
                                        ...
                                        <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                            ...
                                            <li class="nav-item">
                                                <a href="#orden-medica" data-bs-toggle="tab" class="nav-link rounded-0">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="ajustes">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="historia_deportiva" class="form-label">
                                                                Historia
                                                                deportiva:</label>
                                        ...
                                        <div class="box-footer text-end">
                                            <button id="btn-guardarHistoria" onclick="guardarHistoria()"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="justified-tabs-preview">
                                        <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                            ...
                                            <li class="nav-item">
                                                <a href="#datos_rips_neuro" data-bs-toggle="tab" aria-expanded="false"
                                        ...
                                        <div class="tab-content px-20">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" id="codConsultaConsulta" name="codConsultaConsulta"></select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="evolucion_plan" class="form-label">Evolución y/o Plan de manejo:</label>
                                                            <textarea class="form-control" id="evolucion_plan" name="evolucion_plan" rows="5"
                                                                placeholder="Evolución del tratamiento neuropsicológico actual"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" style="width: 100%;"
                                                                id="profesionalConsulta" name="profesionalConsulta"></select>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Datos RIPS -->
                                            <div class="tab-pane" id="datos_rips_neuro">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="form-label">Impresión diagnóstica principal (CIE-10)</label>
                                                            <div class="d-flex gap-2">
                                                                <select class="form-control select2" id="codImpresionDiagnosticoConsulta" name="codImpresionDiagnosticoConsulta"></select>
                                                                <button type="button" class="btn btn-secondary" onclick="clearSelect('codImpresionDiagnosticoConsulta')"><i class="fa fa-times"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
...
<script>
    ...
    function cargarHistorias(page, searchTerm = '') {
        ...
        var oldPageInput = document.getElementById('pageHistoria');
    ...
    function mapearHisoria(historia) {
        ...
        if (historia.codigo_diagnostico != null) {
            cargarCodigoCIE10(historia.codigo_diagnostico, 'codImpresionDiagnostico')
        }

        if (historia.codigo_diagnostico1 != null) {
            cargarCodigoCIE10(historia.codigo_diagnostico1, 'codImpresionDiagnosticoRelacionado1')
        }

        if (historia.codigo_diagnostico2 != null) {
            cargarCodigoCIE10(historia.codigo_diagnostico2, 'codImpresionDiagnosticoRelacionado2')
        }
            ...
            if (element) {
                if (item.tipo == "medicacion") {
                    ...
                    if (element.dataset.role === "tagsinput") {
                        ...
                        element.value = item.detalle ? item.detalle.toLowerCase() : '' // Asignar el valor a un select
    ...
    function editarConsulta(idConsulta) {
        if (hasPermission('editarEvoluciones')) {
            ...
            fetch(url, {
                ...
                .then(response => response.json())
                .then(data => {
                    cargarSelConsulta(data.consulta.cod_servicio, 'codConsultaConsulta')
                    cargarCodigoCIE10(data.consulta.dx_relacionado1, 'dxRelacionado1')
    ...
    function enviarHistoriaPorCorreo(idHistoria, urlPDF) {
        ...
        $("#titulo_loader_pdf").text("Enviando historia");
                ...
                fetch("{{ route('historia.enviarHistoriaCorreoNeuro') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
