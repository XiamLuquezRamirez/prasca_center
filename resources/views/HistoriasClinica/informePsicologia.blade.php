                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-3">
                                    ...
                                    <div class="tab-pane" id="evaluacion" role="tabpanel">
                                        ...
                                        <div class="form-group">
                                            <label for="codImpresionDiagnosticoConsultaSecundaria" class="form-label">Impresión
                                                Diagnóstica secundaria:</label>
                                            <div class="d-flex gap-2">
                                                <select class="form-control select2" id="codImpresionDiagnosticoConsultaSecundaria"
                                                    name="codImpresionDiagnosticoConsultaSecundaria"></select>
                                                <button type="button" class="btn btn-secondary" onclick="clearSelect('codImpresionDiagnosticoConsultaSecundaria')">
                                                    <i class="fa fa-times"></i>
                                                </button>
                                            </div>
                                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if(localStorage.getItem('tipoInforme') == 'abrirInformepsicologia'){
        ...
        $('#codImpresionDiagnosticoConsultaSecundaria').select2({
            dropdownAutoWidth: true,
            width: '100%',
            dropdownParent: $('#modalInformeEvoluciones'),
            placeholder: 'Buscar diagnóstico  por código o nombre...',
    ...
    function editarInforme(idInforme) {
        fetch("{{ route('informes.buscaInformePsicologica') }}", {
            ...
            .then(datosInforme => {
                ...
                CKEDITOR.instances['plan_continuidad'].setData(datosInforme.informe.plan_tratamiento_continuidad)
                ...
                cargarImpresion(datosInforme.informe.impresion_diagnostica_secundaria, 'codImpresionDiagnosticoConsultaSecundaria')
    ...
    function nuevoInforme() {
        ...
        $('#codImpresionDiagnosticoConsultaSecundaria').val(null).trigger('change');
