    ...
    <div class="d-flex align-items-center logo-box justify-content-start">
        ...
        <a href="{{ url('/Administracion') }}" class="logo">
            ...
            <div class="logo-mini w-40">
                <span class="light-logo"><img src="{{ asset('app-assets/images/prasca-center.png') }}" alt="logo"></span>
                        ...
                        <div class="search-bx mx-5">
                            <form>
                                <div class="input-group">
                                  <input type="search" id="busquedaGen" name="busquedaGen" class="form-control" placeholder="Buscar paciente">
