                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="saldoAnteVis">Detalles del saldo anterior:</label>
                            </div>
                        </div>
                        <div class="col-12" style="display: flex; flex-direction: row; gap: 10px; justify-content: space-between;">
                         
                            <div class="form-group cajaDetalles" onclick="seleccinarSaldoAnterior('efectivo')">
                                <label for="saldoAnteVis">Total en efectivo:</label>
                                <span data-efectivo="0" id="totalEfectivo"><strong>$ 0,00</strong></span>
                            </div>
                            <div class="form-group cajaDetalles">
                                <label for="saldoAnteVis">Total en transferencias:</label>
                                <span data-total-transferencias="0" id="totalTransferencias"><strong>$ 0,00</strong></span>
                            </div>
                            <div class="form-group cajaDetalles" 
                                <label for="saldoAnteVis">Total en tarjetas:</label>
                                <span data-total-tarjetas="0" id="totalTarjetas"><strong>$ 0,00</strong></span>
                            </div>
                            <div class="form-group cajaDetalles" >
                                <label for="saldoAnterior"> Saldo caja anterior:</label>
                                <span data-saldo-anterior="0" id="saldoAnterior"><strong>$ 0,00</strong></span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onchange="cambioFormato(this.id, 'saldoAnte');"
                                    onkeypress="return validartxtnum(event)" onclick="this.select()" id="saldoAnteVis"
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" onchange="cambioFormato(this.id, 'abono');"
            ...
            <div class="modal-body">
                <div class="card-body">
                    ...
                    <form id="formGuardarCierreCaja">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label for="userinput8">Fecha de cierre:</label>
                                ...
                                <div class="form-group d-flex align-items-center position-relative">
                                    ...
                                    <div class="date-picker">
                                        <input type="date" id="fecCierreDate" onchange="cargarCierre(this.value)" name="fecCierre" cplaceholder="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" onchange="cambioFormato(this.id, 'valorMontoCierre');"
...
<script>
    ...
    function cambioFormato(id, tipo) {
        let numero = document.getElementById(id)
        if (numero.value == '') {
            numero.value = 0
        }
        document.getElementById(tipo).value = numero.value
    ...
    function cargar(page, searchTerm = '') {
        ...
        fetch(url, {
            ...
            .then(responseData => {
                ...
                $("#saldoAnte").val(responseData.recaudosEfectivo);
                $("#saldoAnteVis").val(formatCurrency(responseData.recaudosEfectivo,
                    'es-CO', 'COP'));

                    
                document.getElementById('totalEfectivo').setAttribute('data-efectivo', responseData.recaudosEfectivo);
                $("#totalEfectivo").html(formatCurrency(responseData.recaudosEfectivo,
                    'es-CO', 'COP'));
                
                document.getElementById('totalTarjetas').setAttribute('data-tarjetas', responseData.recaudosTarjetac + responseData.recaudosTarjetad);
                $("#totalTarjetas").html(formatCurrency(responseData.recaudosTarjetac + responseData.recaudosTarjetad,
                    'es-CO', 'COP'));
                
                
                document.getElementById('totalTransferencias').setAttribute('data-transferencias', responseData.recaudosTransferencia);
                $("#totalTransferencias").html(formatCurrency(responseData.recaudosTransferencia,
                    'es-CO', 'COP'));
                
                document.getElementById('saldoAnterior').setAttribute('data-saldo-anterior', responseData.saldoAnterior);
                $("#saldoAnterior").html(formatCurrency(responseData.saldoAnterior,
                    'es-CO', 'COP'));
            })
            .catch(error => console.error('Error:', error));
    ...
    function seleccinarSaldoAnterior(tipo) {
        if (tipo == 'efectivo') {
            $("#saldoAnteVis").val(formatCurrency(document.getElementById('totalEfectivo').getAttribute('data-efectivo'),
                'es-CO', 'COP'));
            $("#saldoAnte").val(document.getElementById('totalEfectivo').getAttribute('data-efectivo'));
        }
        if (tipo == 'transferencia') {
            $("#saldoAnteVis").val(formatCurrency(document.getElementById('totalTransferencias').getAttribute('data-transferencias'),
                'es-CO', 'COP'));
            $("#saldoAnte").val(document.getElementById('totalTransferencias').getAttribute('data-transferencias'));
        }
        if (tipo == 'tarjeta') {
            $("#saldoAnteVis").val(formatCurrency(document.getElementById('totalTarjetas').getAttribute('data-tarjetas'),
                'es-CO', 'COP'));
            $("#saldoAnte").val(document.getElementById('totalTarjetas').getAttribute('data-tarjetas'));
        }
        if (tipo == 'saldo') {
            $("#saldoAnteVis").val(formatCurrency(document.getElementById('saldoAnterior').getAttribute('data-saldo-anterior'),
                'es-CO', 'COP'));
            $("#saldoAnte").val(document.getElementById('saldoAnterior').getAttribute('data-saldo-anterior'));
        }
    }
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                data.recaudos.forEach(function(recaudo, index) {
                    ...
                    detaRecaudos += '<tr>' +
                        '<td>' + (index + 1) + '</td>' +
                        '<td >' + recaudo.nombre_completo + ' (' + recaudo.tipo + ': ' + recaudo.descripcion + ')</td>' +
    ...
    function cerrarCaja() {
        ...
        document.getElementById('fecCierreDate').value = fechaHoy;
    ...
    function confirmarCierre() {
        ...
        if (document.getElementById('fecCierreDate').value == '') {
            swal("¡Alerta!", "Debe seleccionar una fecha de cierre", "error");
            return;
        }
            ...
            table: {
                ...
                body: [
                    ...
                    ...respuestaGlobal.recaudos.map(recaudo => [
                        ...
                        `${recaudo.nombre_completo} (${recaudo.tipo}: ${recaudo.descripcion})`,
    ...
    function cargarCierre(fecha) {
        let url = "{{ route('cajas.consultarMontoCierre') }}";
        const formData = new FormData();
        let idCaja = document.getElementById('idCajaCierre').value;
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                document.getElementById('valorMontoCierre').value = data.monto;
                document.getElementById('valorVisMontoCierre').value = formatCurrency(data.monto, 'es-CO', 'COP');
                document.getElementById('valorMontoRecaudos').value = data.recaudos;
                document.getElementById('valorMontoGastos').value = data.gastos;
