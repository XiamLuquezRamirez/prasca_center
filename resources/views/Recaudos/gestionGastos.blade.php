        ...
        <div class="row mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mb-0" id="gastosTotales">$ 45,000.00</h3>
                                            </div>
                                            <div class="text-end">
                            ...
                            <div class="col-md-4">
                                <div class="card bg-success text-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="card-title mb-0">Pago con caja</h6>
                                                <h3 class="mb-0" id="gastosDeCaja">$ 0.00</h3>
                                            </div>
                                            <div class="text-end">
                                                <i class="fa fa-money fa-2x opacity-75"></i>
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-danger text-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="card-title mb-0">Pago con otro recurso</h6>
                                                <h3 class="mb-0" id="gastosDeOtro">$ 0.00</h3>
                                            </div>
                                            <div class="text-end">
                                                <i class="fa fa-credit-card fa-2x opacity-75"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="listado" class="col-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Cards de información de gastos -->
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:20%;">Origen de recurso</th>
                ...
                <div class="modal-body">
                    <form id="formGastos">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="referencia" class="form-label">Origen de recurso :</label>
                                    <select class="form-select" id="origenRecurso" name="origenRecurso">
                                        <option value="">Seleccione un origen de recurso</option>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $("#formGastos").validate({
                ...
                messages: {
                    ...
                    origenRecurso: {
                        required: "Por favor, seleccione el origen de recurso."
                    }
                },
        ...
        function editarRegistro(idGasto) {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    document.getElementById("origenRecurso").value = data.origen_recurso
        ...
        function cargar(page, searchTerm = '') {
            ...
            fetch(url, {
                ...
                .then(responseData => {
                    ...
                    // Actualizar las cards con los valores de gastos
                    document.getElementById('gastosTotales').innerHTML = '$ ' + responseData.gastosTotales;
                    document.getElementById('gastosDeCaja').innerHTML = '$ ' + responseData.gastosDeCaja;
                    document.getElementById('gastosDeOtro').innerHTML = '$ ' + responseData.gastosDeOtro;
                })
                .catch(error => console.error('Error:', error));
